...
public class GoodController {
	...
	public String getHomeGoodsBySearch(
			ModelMap model,
			@RequestParam(required = false, defaultValue = "") String searchText,
			@RequestParam(required = false) Integer secondTypeId,
			@RequestParam(required = false, defaultValue = "0") int offset,
			@RequestParam(required = false, defaultValue = "40") int limit) throws UnsupportedEncodingException {
	
		System.out.println("测试搜索============"+searchText);
	...
	public String getHomeGoods(
			...
			@RequestParam(required = false, defaultValue = "0") int offset,
			@RequestParam(required = false, defaultValue = "40") int limit) throws UnsupportedEncodingException {
		System.out.println("测试搜索============"+searchText.getBytes());
